...
int segt(
         ...
         iREAL ySegB,
         iREAL zSegB,
         iREAL xCoordinatesOfPointsOfGeometry[3],
         iREAL yCoordinatesOfPointsOfGeometry[3],
         iREAL zCoordinatesOfPointsOfGeometry[3],
         iREAL xP,
         iREAL yP,
         iREAL zP,
         iREAL xQ,
         ...
         )
{
  ...
  u[0] = xCoordinatesOfPointsOfGeometry[1] - xCoordinatesOfPointsOfGeometry[0];
  u[1] = yCoordinatesOfPointsOfGeometry[1] - yCoordinatesOfPointsOfGeometry[0];
  u[2] = zCoordinatesOfPointsOfGeometry[1] - zCoordinatesOfPointsOfGeometry[0];
  
  v[0] = xCoordinatesOfPointsOfGeometry[2] - xCoordinatesOfPointsOfGeometry[0];
  v[1] = yCoordinatesOfPointsOfGeometry[2] - xCoordinatesOfPointsOfGeometry[0];
  v[2] = zCoordinatesOfPointsOfGeometry[2] - xCoordinatesOfPointsOfGeometry[0];
  ...
  w0[0] = xSegA - xCoordinatesOfPointsOfGeometry[0];
  w0[1] = ySegA - yCoordinatesOfPointsOfGeometry[0];
  w0[2] = zSegA - zCoordinatesOfPointsOfGeometry[0];//6 flops
  ...
  xP = xSegA + r * dir[0];
  yP = ySegA + r * dir[1];
  zP = zSegA + r * dir[2];//7 flops
  
  xQ = xSegA + r * dir[0];
  yQ = ySegA + r * dir[1];
  zQ = zSegA + r * dir[2];//7 flops
  
  uu = DOT(u,u);
  uv = DOT(u,v);
  vv = DOT(v,v);
  
  w[0] = xP - xCoordinatesOfPointsOfGeometry[0];
  w[1] = yP - yCoordinatesOfPointsOfGeometry[0];
  w[2] = zP - zCoordinatesOfPointsOfGeometry[0];
      ...
      ) 
{
  ...
  iREAL A[3], B[3], C[3], D[3], E[3], F[3], P[3];
  
  A[0] = xCoordinatesOfPointsOfGeometryA[0];//A
  A[1] = yCoordinatesOfPointsOfGeometryA[0];
  A[2] = zCoordinatesOfPointsOfGeometryA[0];
  
  B[0] = xCoordinatesOfPointsOfGeometryA[1];//B
  B[1] = yCoordinatesOfPointsOfGeometryA[1];
  B[2] = zCoordinatesOfPointsOfGeometryA[1];
  
  C[0] = xCoordinatesOfPointsOfGeometryA[2];//C
  C[1] = yCoordinatesOfPointsOfGeometryA[2];
  C[2] = zCoordinatesOfPointsOfGeometryA[2];
  
  D[0] = xCoordinatesOfPointsOfGeometryB[0];//D
  D[1] = yCoordinatesOfPointsOfGeometryB[0];
  D[2] = zCoordinatesOfPointsOfGeometryB[0];
  
  E[0] = xCoordinatesOfPointsOfGeometryB[1];//E
  E[1] = yCoordinatesOfPointsOfGeometryB[1];
  E[2] = zCoordinatesOfPointsOfGeometryB[1];
  
  F[0] = xCoordinatesOfPointsOfGeometryB[2];//F
  F[1] = yCoordinatesOfPointsOfGeometryB[2];
  F[2] = zCoordinatesOfPointsOfGeometryB[2];
  
  
  if (segt(xCoordinatesOfPointsOfGeometryB[0], yCoordinatesOfPointsOfGeometryB[0], zCoordinatesOfPointsOfGeometryB[0],
           xCoordinatesOfPointsOfGeometryB[1], yCoordinatesOfPointsOfGeometryB[1], zCoordinatesOfPointsOfGeometryB[1],
           xCoordinatesOfPointsOfGeometryA, yCoordinatesOfPointsOfGeometryA, zCoordinatesOfPointsOfGeometryA,
           xPA, yPA, zPA, xPB, yPB, zPB) == 1)
  {
    intersection = 1;
  } else if (segt(xCoordinatesOfPointsOfGeometryB[1], yCoordinatesOfPointsOfGeometryB[1], zCoordinatesOfPointsOfGeometryB[1],
                  xCoordinatesOfPointsOfGeometryB[2], yCoordinatesOfPointsOfGeometryB[2], zCoordinatesOfPointsOfGeometryB[2],
                  xCoordinatesOfPointsOfGeometryA, yCoordinatesOfPointsOfGeometryA, zCoordinatesOfPointsOfGeometryA,
                  xPA, yPA, zPA, xPB, yPB, zPB) == 1)
  {
    intersection = 1;
  } else if (segt(xCoordinatesOfPointsOfGeometryB[2], yCoordinatesOfPointsOfGeometryB[2], zCoordinatesOfPointsOfGeometryB[2],
                  xCoordinatesOfPointsOfGeometryB[0], yCoordinatesOfPointsOfGeometryB[0], zCoordinatesOfPointsOfGeometryB[0],
                  xCoordinatesOfPointsOfGeometryA, yCoordinatesOfPointsOfGeometryA, zCoordinatesOfPointsOfGeometryA,
                  xPA, yPA, zPA, xPB, yPB, zPB) == 1)
  {
    intersection = 1;
  } else if (segt(xCoordinatesOfPointsOfGeometryA[0], yCoordinatesOfPointsOfGeometryA[0], zCoordinatesOfPointsOfGeometryA[0],
                  xCoordinatesOfPointsOfGeometryA[1], yCoordinatesOfPointsOfGeometryA[1], zCoordinatesOfPointsOfGeometryA[1],
                  xCoordinatesOfPointsOfGeometryA, yCoordinatesOfPointsOfGeometryA, zCoordinatesOfPointsOfGeometryA,
                  xPA, yPA, zPA, xPB, yPB, zPB) == 1)
  {
    intersection = 1;
  } else if (segt(xCoordinatesOfPointsOfGeometryA[1], yCoordinatesOfPointsOfGeometryA[1], zCoordinatesOfPointsOfGeometryA[1],
                  xCoordinatesOfPointsOfGeometryA[2], yCoordinatesOfPointsOfGeometryA[2], zCoordinatesOfPointsOfGeometryA[2],
                  xCoordinatesOfPointsOfGeometryA, yCoordinatesOfPointsOfGeometryA, zCoordinatesOfPointsOfGeometryA,
                  xPA, yPA, zPA, xPB, yPB, zPB) == 1)
  {
    intersection = 1;
  } else if (segt(xCoordinatesOfPointsOfGeometryA[2], yCoordinatesOfPointsOfGeometryA[2], zCoordinatesOfPointsOfGeometryA[2],
                  xCoordinatesOfPointsOfGeometryA[0], yCoordinatesOfPointsOfGeometryA[0], zCoordinatesOfPointsOfGeometryA[0],
                  xCoordinatesOfPointsOfGeometryA, yCoordinatesOfPointsOfGeometryA, zCoordinatesOfPointsOfGeometryA,
                  xPA, yPA, zPA, xPB, yPB, zPB) == 1)
  {
    intersection = 1;
